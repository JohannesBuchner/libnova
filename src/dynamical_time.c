...
static double get_dynamical_diff_near (double JD)
{
    ...
    double delta_T[3] = {56.9, 67.0 ,80.0};
    double a,b,c,n;
    ...
    /* get number of days since 1990 and divide by 10 years */
	n = (JD - 2447892.5) / 3652.5;
...
double get_dynamical_diff_other (double JD)
{     
    double TD;
    double a;
